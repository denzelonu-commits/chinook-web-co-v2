...
const Navigation = React.memo(() => {
  ...
  return (
    <header className="sticky top-0 w-full z-10 border-b border-gray-800/50 bg-black/80 backdrop-blur-md">
...
export default function Component() {
  return (
    <main className="h-full overflow-y-auto bg-black text-white">
      <Navigation />
      <Hero />
    </main>
  );
